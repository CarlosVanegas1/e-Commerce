            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <?php } ?>
                        <a href="Firebase/public/" class="nav-link text-info" category="all">IOT</a>
                    </ul>
                </div>
            </div>
        </nav>
    ...
    <header class="bg-dark py-5">
        <div class="container px-4 px-lg-5 my-5">
            <div class="text-center text-white">
                ...
                <p class="lead fw-normal text-white-50 mb-0">Expertos en crear sabores de inspiración</p>
            </div>
        </div>
    </header>
    <section class="py-5">
                            ...
                            <div class="card h-100">
                                ...
                                <div class="card-body p-4">
                                    <div class="text-center">
                                        ...
                                        <!-- Product price-->
                                        <span class="text-muted text-decoration-line-through"><?php echo $data['precio_normal']." USD" ?></span>
                                        <?php echo $data['precio_rebajado']." USD" ?>
                                    </div>
                                </div>
                                <!-- Product actions-->
