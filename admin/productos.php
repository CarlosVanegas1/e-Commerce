...
if (isset($_POST)) {
    if (!empty($_POST)) {
        ...
        $query = mysqli_query($conexion, "INSERT INTO productos(nombre, descripcion, precio_normal, precio_rebajado, cantidad, imagen, id_categoria) 
                                                     VALUES ('$nombre', '$descripcion', '$p_normal', '$p_rebajado', $cantidad, '$foto', $categoria)");
        if ($query) {
                ...
                <tbody>
                    ...
                    while ($data = mysqli_fetch_assoc($query)) { ?>
                        <tr>
                            ...
                            <td><?php echo $data['precio_normal']." USD"; ?></td>
                            <td><?php echo $data['precio_rebajado']." USD"; ?></td>
